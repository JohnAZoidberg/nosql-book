...
It is possible to configure different clusters and 
...
By default each node is placed on the ring just once, when using virtual nodes they each can be placed on the node multiple times. This brings three advantages:
