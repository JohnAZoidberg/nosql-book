...
Or put in other words; "Sparse, distributed multi-dimensional sorted map" \tinycite{chang2008bigtable}
...
\Being{itemize}
        ...
        (Those writes include \lstinline{INSERT} \lstinline{UPDATE} \lstinline{DELETE})
...
\begin{itemize}
        ...
        \item Data validation (e.g. \lstinline{NULL} constraint, uniqueness) (It has to be noted, that Cassandra does not read before writing. Any similar needs are not possible)
\end{itemize}
